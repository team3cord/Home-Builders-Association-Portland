...
<head>
	...
	<meta name="description" content="The HBA has promoted the home building industry since 1942. We provide services to builders and other industry professionals in Portland metro area." />
...
<script type="text/javascript" src="http://hbapdx.org/support/scroll-img/jsScroller.js"></script>
<script type="text/javascript" src="http://hbapdx.org/support/scroll-img/jsScrollbar.js"></script>
<script type="text/javascript">
var scroller  = null;
var scrollbar = null;
window.onload = function () {
  ...
  jQuery library
-->
<script type="text/javascript" src="http://hbapdx.org/includes/lib/jquery-1.4.2.min.js"></script>
<!--
  jCarousel library
-->
<script type="text/javascript" src="http://hbapdx.org/includes/lib/jquery.jcarousel.min.js"></script>
<!--
  jCarousel skin stylesheet
-->
<link rel="stylesheet" type="text/css" href="http://hbapdx.org/includes/skins/tango/skin.css">
<script type="text/javascript">
...
<!-- LOGO/NAV ====================================== -->
 <div id="header"> 
		...
		<div style="border-bottom:#4f8ac2 2px solid; height:2px; margin-top:40px; width:980px;"></div>
		 ...
		 <!-- UTILITY NAV ====================================== -->
 	<div style="z-index:4; position:absolute; top:250px; right:0px; width:343px; height:27px; background-image:url(http://hbapdx.org/wp-content/themes/HBP/images/secondary-nav-bg.jpg); background-repeat:no-repeat;">
